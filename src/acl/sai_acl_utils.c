...
static const struct {
    ...
    {SAI_ACL_ENTRY_ATTR_FIELD_IP_TYPE, SAI_ACL_ENTRY_ATTR_ENUM},
    {SAI_ACL_ENTRY_ATTR_FIELD_IP_FRAG, SAI_ACL_ENTRY_ATTR_ENUM},
    ...
    {SAI_ACL_ENTRY_ATTR_FIELD_VLAN_TAGS, SAI_ACL_ENTRY_ATTR_ENUM},
