 ...
 *
 * @param[in] bridge_port_id Bridge port SAI Object identifier
 * @param[inout] count Size of vlan_member_list.During out has Number of VLAN members mapped to bridge port
 * @param[out] List of VLAN member object IDs mapped
 * @return SAI_STATUS_SUCCESS if successful otherwise a different
 *  error code is returned.
 */
 ...
 *
 * @param[in] bridge_port_id Bridge port SAI Object identifier
 * @param[inout] count Size of stp_port_list.During out has Number of STP Ports mapped to bridge port
 * @param[out] List of STP Port object IDs mapped
 * @return SAI_STATUS_SUCCESS if successful otherwise a different
 *  error code is returned.
 */
...
/**
 * @brief Get L2MC Member list mapped to bridge port
 *
 * @param[in] bridge_port_id Bridge port SAI Object identifier
 * @param[inout] count Size of l2mc_member_list.During out has Number of L2MC members mapped to bridge port
 * @param[out] List of L2MC member object IDs mapped
 * @return SAI_STATUS_SUCCESS if successful otherwise a different
 *  error code is returned.
 */
